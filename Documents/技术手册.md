...
| [`Documents/Done/真机冒烟清单.md`](Done/真机冒烟清单.md) | **PR-PC-smoke**：上电→Boot→桌面；键/盘/网勾选 |
...
| I4 | **PR-PC-smoke ✅**：[`真机冒烟清单.md`](Done/真机冒烟清单.md)（上电→Boot→桌面；键/盘/网） |
...
| 冒烟勾选 | 板 README | [`真机冒烟清单.md`](Done/真机冒烟清单.md)（**PC-smoke**） |
...
> 匹配：[`驱动/驱动匹配规范.md`](驱动/驱动匹配规范.md)；设计稿已归档 [`Done/驱动模板设计.md`](Done/驱动模板设计.md)。  
