...
> **操作手册**：[`如何增加一个驱动.md`](如何增加一个驱动.md)（含真机 NVMe / NIC）；virtio 范例：[`写一个virtio-xxx.md`](写一个virtio-xxx.md)。
...
文档范例：[`写一个virtio-xxx.md`](写一个virtio-xxx.md)（**D3 ✅**）含匹配 ID、ops、`ToyDriverRegister`、串口/`lsdev` 验收。
