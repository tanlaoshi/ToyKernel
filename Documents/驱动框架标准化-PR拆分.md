...
> **PR-D-tpl-0** ✅ TG `5e86cc5`：`[驱动模板设计.md](驱动模板设计.md)`。**PR-D-tpl-1** 本地齐待 TG；下一刀 **PR-D-tpl-2**。
...
| 3 模板   | **PR-D-tpl-1**     | `HAL/X64/Drivers/_template/`（**无 .o 进 Kernel**）      | `./build.sh`；精确 `nm`（设计稿 §1.2）无匹配；README 5 步开篇；**本地齐待 TG**                                                                |
