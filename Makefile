...
all: $(USER_HELLO_ELF) $(USER_COUNT_ELF) $(USER_FORK_ELF) $(USER_WAITNH_ELF) \
	...
	$(USER_SIGDEMO_ELF) \
	$(USER_WINDEMO_ELF) $(USER_GUIDEMO_ELF) $(USER_BLITDEMO_ELF) $(USER_LIBCDEMO_ELF) $(USER_SLEEPDEMO_ELF) $(USER_DIRDEMO_ELF) \
...
ifeq ($(ARCH),x86_64)
	...
	rm -f $(USER_WINDEMO_OBJ) $(USER_GUIDEMO_OBJ) $(USER_BLITDEMO_OBJ) $(USER_LIBCDEMO_OBJ) $(USER_SLEEPDEMO_OBJ) $(USER_DIRDEMO_OBJ)
	...
	rm -f $(USER_WINDEMO_ELF) $(USER_GUIDEMO_ELF) $(USER_BLITDEMO_ELF) $(USER_LIBCDEMO_ELF) $(USER_SLEEPDEMO_ELF) $(USER_DIRDEMO_ELF)
