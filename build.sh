...
if [ "$ARCH" = "x86_64" ]; then
    ...
    echo "Copied HELLO/COUNT/FORK/WAITNH/DYNDEMO/LIBTOY/CAT/WRITE/NETDEMO/NETSRV -> ../ToyImage/"
    if [ -d ../ToyImage/rootfs ]; then
        ...
        echo "Synced WRITE/WAITNH/DYNDEMO/LIBTOY/NETDEMO/NETSRV -> ../ToyImage/rootfs/"
    fi
fi
