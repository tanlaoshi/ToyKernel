...
static const char *const gMsgKeys[MSG_COUNT] = {
    ...
    "MSG_SET_SCALE",
    "MSG_SET_THEME",
    "MSG_SET_THEME_DEFAULT",
    "MSG_SET_THEME_TECH",
    "MSG_SET_THEME_GRAD",
    "MSG_SET_EFFECTS",
    "MSG_SET_EFFECTS_MINIMAL",
    "MSG_SET_EFFECTS_LOW",
    "MSG_SET_EFFECTS_MEDIUM",
    "MSG_SET_EFFECTS_HIGH",
    "MSG_SET_HINT_MAIN",
    "MSG_SET_HINT_BACK",
    "MSG_SET_SAVED",
    "MSG_SET_SAVED_PC",
...
static const char *const gEnFallback[MSG_COUNT] = {
    ...
    "Saved. Reboot to apply (nearest GOP if needed)",
    "Pref!=Now: quit QEMU + ./run-split.sh",
    "Pref!=Now: reboot PC to apply THEME.CFG",
    " 1. English",
    " 2. Chinese",
    "[Desktop bg]",
    "[Shell bg]",
