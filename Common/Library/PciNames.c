...
static const PCI_CLASS_ENTRY gClasses[] = {
    { 0x00, 0xFF, 0xFF, "Unclassified device" },
    ...
    { 0x04, 0x03, 0xFF, "Audio controller" },
    { 0x04, 0xFF, 0xFF, "Multimedia controller" },
    ...
    { 0x07, 0xFF, 0xFF, "Simple comm controller" },
    { 0x08, 0xFF, 0xFF, "Base peripheral" },
    { 0x09, 0xFF, 0xFF, "Input controller" },
    { 0x0C, 0x03, 0x30, "USB xHCI" },
    { 0x0C, 0x03, 0x20, "USB EHCI" },
    { 0x0C, 0x03, 0xFF, "USB controller" },
    { 0x0C, 0x05, 0xFF, "SMBus controller" },
