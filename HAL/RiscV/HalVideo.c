 ...
 * HAL/RiscV/HalVideo.c — 帧缓冲门面桩（无 GOP 驱动）
...
void HalVideoCopyRect(UINT32 SrcX, UINT32 SrcY, UINT32 DstX, UINT32 DstY,
    ...
    (void)SrcX; (void)SrcY; (void)DstX; (void)DstY; (void)Width; (void)Height;
...
void HalVideoWriteRect(UINT32 X, UINT32 Y, UINT32 Width, UINT32 Height, const UINT32 *In) {
    ...
    (void)X; (void)Y; (void)Width; (void)Height; (void)In;
...
void HalVideoDrawCodepointAt(UINT32 X, UINT32 Y, UINT32 Cp, UINT32 Color) {
    ...
    (void)X; (void)Y; (void)Cp; (void)Color;
...
void HalVideoDrawChar(char C, UINT32 Color) { (void)C; (void)Color; }



void HalVideoDrawString(const char *Text, UINT32 Color) {

    (void)Text; (void)Color;
...
void HalVideoSetClipRegion(UINT32 X, UINT32 Y, UINT32 Width, UINT32 Height, UINT32 Background) {
    ...
    (void)X; (void)Y; (void)Width; (void)Height; (void)Background;
...
void HalVideoSetTextCursor(UINT32 X, UINT32 Y) { (void)X; (void)Y; }
